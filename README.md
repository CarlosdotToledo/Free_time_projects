...
program I have made independently. it taught me how to use: input,isspace, .lower() .upper(), .replace(), complex, except, try, isdigit(),isalnum()
...
meaning that it would skip over some of my filters and output that there was not a number with "8 or i guess"
